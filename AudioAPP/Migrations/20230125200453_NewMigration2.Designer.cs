...
namespace AudioAPP.Migrations
{
    ...
    [Migration("20230125200453_NewMigration2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AudioAPP.Models.SignedUser", b =>
                {
                    b.HasBaseType("Microsoft.AspNetCore.Identity.IdentityUser");

                    b.HasDiscriminator().HasValue("SignedUser");
                });
            ...
            modelBuilder.Entity("AudioAPP.Models.Author", b =>
                {
                    ...
                    b.HasOne("AudioAPP.Models.SignedUser", "IdentityUser")
                        .WithOne("Author")
                        .HasForeignKey("AudioAPP.Models.Author", "IdentityUserId");
